    ...
    <header className="flex items-center justify-between h-16 px-6 glass-card backdrop-blur-2xl backdrop-saturate-150 bg-surface-950/80 border-b border-white/10 shadow-lg shadow-black/40 shrink-0 z-20 sticky top-0">
      ...
      <div className="flex-1 max-w-md mx-4">
        <div className="relative group/search">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-zinc-400 group-focus-within/search:text-purple-300 group-hover/search:text-white transition-colors duration-300 pointer-events-none" />
          <input
            type="text"
            value={query}
            ...
            className="w-full h-11 pl-11 pr-4 rounded-full bg-white/[0.04] hover:bg-white/[0.07] backdrop-blur-xl border border-white/10 group-hover/search:border-purple-500/30 text-sm font-medium text-white placeholder:text-zinc-400/70 caret-purple-400 focus:outline-none focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/30 focus:bg-surface-950/90 shadow-md shadow-purple-950/20 focus:shadow-[0_0_24px_rgba(168,85,247,0.25)] transition-all duration-300 ease-out"
          />
        </div>
      </div>
